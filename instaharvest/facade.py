...
from instaharvest.config.settings import Settings
from instaharvest.actions import Actions
...
from instaharvest.infrastructure.logger import get_logger
from instaharvest.infrastructure.session import FileSessionStore
from instaharvest.evasion import EvasionManager
...
from instaharvest.scrapers.hashtag import HashtagScraper
from instaharvest.scrapers.highlights import HighlightScraper
from instaharvest.scrapers.location import LocationScraper
from instaharvest.scrapers.media import MediaScraper
...
class InstaHarvest:
    ...
    def actions(self) -> Actions:
        ...
        Off by default. See :mod:`instaharvest.actions` package
